...
//    private static final String CONFIG_FILE_NAME = "pinpoint-collector.properties";
    ...
    private static final String LOG_KEY_VALUE = "{}={}";
...
//    private SimpleProperty SYSTEM_PROPERTY = SystemProperty.INSTANCE;
    ...
    public String getTcpTopic() {
        return this.tcpTopic;
    }

    public void setTcpTopic(String tcpTopic) {
        this.tcpTopic = tcpTopic;
    }

    public String getSpanTopic() {
        return this.spanTopic;
    }
    ...
    public String getStatTopic() {
        return this.statTopic;
    }

    public void setStatTopic(String statTopic) {
    ...
    public int getUdpthreadNumber() {
        return udpthreadNumber;
    }

    public void setUdpthreadNumber(int udpthreadNumber) {
        this.udpthreadNumber = udpthreadNumber;
    }
...
//    }
    ...
    private void readPropertyValues(Properties properties) {
        ...
        this.kafkaZK = kafkaIp + ":" + kafkaPort;
        this.kafkaGroupId = readString(properties, "collector.kafka.consumer.groupid", "group1");
        this.tcpTopic = readString(properties, "collector.kafka.consumer.tcp.topic", "tcpmeta");
        this.statTopic = readString(properties, "collector.kafka.consumer.stat.topic", "updstat");
        this.spanTopic = readString(properties, "collector.kafka.consumer.span.topic", "udpspan");
        this.tcpThreadCount = readInt(properties, "collector.kafka.consumer.tcp.tcpThreadCount", 1);
        this.udpthreadNumber = readInt(properties, "collector.kafka.consumer.udp.threadNumber", 1);
    }
    ...
    private String readString(Properties properties, String propertyName, String defaultValue) {
        ...
        if (logger.isInfoEnabled()) {
            logger.info(LOG_KEY_VALUE, propertyName, result);
        }
        return result ;
    }
    ...
    public String toString() {
        return "CollectorConfiguration{" +
                "tcpListenIp='" + tcpListenIp + '\'' +
                ", tcpListenPort=" + tcpListenPort +
                ", tcpWorkerThread=" + tcpWorkerThread +
                ", tcpWorkerQueueSize=" + tcpWorkerQueueSize +
                ", udpStatListenIp='" + udpStatListenIp + '\'' +
                ", udpStatListenPort=" + udpStatListenPort +
                ", udpStatWorkerThread=" + udpStatWorkerThread +
                ", udpStatWorkerQueueSize=" + udpStatWorkerQueueSize +
                ", udpStatSocketReceiveBufferSize=" + udpStatSocketReceiveBufferSize +
                ", udpSpanListenIp='" + udpSpanListenIp + '\'' +
                ", udpSpanListenPort=" + udpSpanListenPort +
                ", udpSpanWorkerThread=" + udpSpanWorkerThread +
                ", udpSpanWorkerQueueSize=" + udpSpanWorkerQueueSize +
                ", udpSpanSocketReceiveBufferSize=" + udpSpanSocketReceiveBufferSize +
                ", agentEventWorkerThreadSize=" + agentEventWorkerThreadSize +
                ", agentEventWorkerQueueSize=" + agentEventWorkerQueueSize +
                ", l4IpList=" + l4IpList +
                ...
                ", spanTopic='" + spanTopic + '\'' +
                ", statTopic='" + statTopic + '\'' +
                ", tcpThreadCount=" + tcpThreadCount +
                ", udpthreadNumber=" + udpthreadNumber +
                '}';
    }
}
