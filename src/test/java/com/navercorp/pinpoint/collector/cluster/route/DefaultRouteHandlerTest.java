...
public class DefaultRouteHandlerTest {
    ...
    public void testName() throws Exception {
        ...
        assertEquals(1, requestFilter.getCallCount());
        assertEquals("TCommandTransferResponse(routeResult:NOT_FOUND, payload:)", response.toString());
        ...
        assertEquals(2, requestFilter.getCallCount());
        assertEquals(1, responseFilter.getCallCount());

        assertEquals(TRouteResult.NOT_FOUND, response.getRouteResult());
    }
