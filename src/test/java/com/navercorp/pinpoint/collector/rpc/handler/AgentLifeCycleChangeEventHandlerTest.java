...
public class AgentLifeCycleChangeEventHandlerTest {
    ...
    public void exceptionCaught() {
        //given
        PinpointServer server = mock(PinpointServer.class);
        SocketStateCode socketStateCode = SocketStateCode.CLOSED_BY_CLIENT;

        lifeCycleChangeEventHandler.exceptionCaught(server, socketStateCode, new Throwable());
    }
