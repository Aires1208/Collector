...
@PrepareForTest(SystemMonitorDao.class)
public class AgentStatHandlerTest {

    SystemMonitorDao systemMonitorDao = PowerMockito.mock(SystemMonitorDao.class);
    ...
    public void setUp() throws Exception {
        ...
        PowerMockito.whenNew(SystemMonitorDao.class).withAnyArguments().thenReturn(systemMonitorDao);
    }
